import { Level, AcademicClass, TransportLine, AcademicYear, FeeDiscount } from '@/types/settings';
...
export const mockAcademicClasses: AcademicClass[] = [
  // Level 1 Classes
  { id: 'class-kg1-a', name: 'KG1-A', levelId: 'level-1', capacity: 25, isActive: true },
  { id: 'class-kg1-b', name: 'KG1-B', levelId: 'level-1', capacity: 25, isActive: true },
  { id: 'class-kg1-c', name: 'KG1-C', levelId: 'level-1', capacity: 25, isActive: true },
  // Level 2 Classes
  { id: 'class-kg2-a', name: 'KG2-A', levelId: 'level-2', capacity: 25, isActive: true },
  { id: 'class-kg2-b', name: 'KG2-B', levelId: 'level-2', capacity: 25, isActive: true },
  // Level 3 Classes
  { id: 'class-kg3-a', name: 'KG3-A', levelId: 'level-3', capacity: 25, isActive: true },
  { id: 'class-kg3-b', name: 'KG3-B', levelId: 'level-3', capacity: 25, isActive: true },
  // Level 4 Classes
  { id: 'class-g1-a', name: 'Grade 1-A', levelId: 'level-4', capacity: 30, isActive: true },
  { id: 'class-g1-b', name: 'Grade 1-B', levelId: 'level-4', capacity: 30, isActive: true },
  // Level 5 Classes
  { id: 'class-g2-a', name: 'Grade 2-A', levelId: 'level-5', capacity: 30, isActive: true },
  { id: 'class-g2-b', name: 'Grade 2-B', levelId: 'level-5', capacity: 30, isActive: true },
];
